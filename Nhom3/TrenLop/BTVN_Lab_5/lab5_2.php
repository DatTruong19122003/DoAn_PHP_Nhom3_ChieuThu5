...
<html lang="en">
   ...
   <body class="container mx-auto max-w-[30rem]">
      ...
      <div
         ...
         <a href="lab5_2.php?x=1&y=2&z=3"> Link 1</a>
         <a href="lab5_2.php?x[]=1&y[]=2&z[]=3"> Link 2</a>
         <a href="lab5_2.php?mod=product&ac=detail&id=1"> Link 3</a>
         <a href="lab5_2.php?mod=product&ac=list&id=1&name=ABC"> Link 4</a>
      </div>

      <form class="grid grid-cols-[auto,1fr] gap-4 border border-gray-500 p-4 rounded-lg mb-8" action="lab5_2.php"
         method="post">
